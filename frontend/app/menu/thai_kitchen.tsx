...
const DishCard = React.memo(
  ({ dish, width, cartQty, onPress, isPhone, isTablet, isLandscape }: any) => {
    const isServiceChargeVal = dish.isServiceCharge !== undefined ? dish.isServiceCharge : dish.IsServiceCharge;
    const isSC = Number(isServiceChargeVal) === 1 || 
                 isServiceChargeVal === true || 
                 isServiceChargeVal === 'true' || 
                 isServiceChargeVal === '1';
    return (
      <Pressable
